...
const I18N = {
  zh: {
    ...
    zoneSplit:'分区分界层', zoneSplitDesc:'低区电梯服务 1F 到分界层；高区电梯服务 1F（大厅）及分界层到顶层。分界层两区共享，方便换乘。',
  ...
  en: {
    ...
    zoneSplit:'Zone split floor', zoneSplitDesc:'Low-zone elevators serve 1F to split floor; high-zone elevators serve 1F (lobby) and split floor to top. Split floor is shared for transfers.',
